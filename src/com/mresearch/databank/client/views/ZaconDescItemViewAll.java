...
public class ZaconDescItemViewAll extends ZaconDescItemView{

	

	
	public ZaconDescItemViewAll(ZaconDTO_Light dto) {
		super(dto);
		pub_link.setHTML("<a href=\"#\" class=\"more\">Все законы &rarr;</a>");
	}
