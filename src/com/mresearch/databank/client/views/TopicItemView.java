...
public class TopicItemView extends Composite {
	...
	TopicDTO dto;
	public TopicItemView(TopicDTO dto) {
		initWidget(uiBinder.createAndBindUi(this));
		this.dto = dto;
		pub_link.setHTML("<span class=\"yellow italic\">"+dto.getHeader()+"</span>");
	}
	@UiHandler(value="pub_link")
	public void doGo(ClickEvent ev)
	{
		DatabankApp.get().getEventBus().fireEvent(new ShowPublicationIndexEvent(dto.getId(), dto.getHeader(), dto.getItems()));
	}
