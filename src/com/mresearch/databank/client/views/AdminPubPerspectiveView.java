...
public class AdminPubPerspectiveView extends Composite implements AdminPubPerspectivePresenter.Display{
	...
	interface AdminResearchPerspectiveViewUiBinder extends
			UiBinder<Widget, AdminPubPerspectiveView> {
	}
	...
	SimplePublicationList simplePubListItem;
	...
	public AdminPubPerspectiveView(SimpleEventBus bus) {
		initWidget(uiBinder.createAndBindUi(this));
		this.bus = bus;
		add_concept_popup = new AddConceptPopupView(this.bus);
		//tree = new Tree();
		//tree.setStyleName("research-catalog");
		TreeItem db = new TreeItem("_Банк публикаций_");
		simplePubListItem = new SimplePublicationList();
		rootDataLawConcepts = new RootConceptsList("publication","Рубрики");
		db.addItem(simplePubListItem);
