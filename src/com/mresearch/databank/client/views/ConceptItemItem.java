...
public class ConceptItemItem extends ConceptItemEntity
{
  ...
  public void refreshContents() {
	...
	private ArrayList<Long> all_tagged_ids = new ArrayList<Long>();
	public ArrayList<Long> getAll_tagged_ids() {
		return all_tagged_ids;
	}

	public ArrayList<String> getAll_tagged_idents() {
		return all_tagged_idents;
	}

	private ArrayList<String> all_tagged_idents = new ArrayList<String>();
	...
	public void refreshTaggedEntitiesIDs(final AsyncAction act)
	{
