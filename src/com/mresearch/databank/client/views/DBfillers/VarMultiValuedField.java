...
public class VarMultiValuedField extends Composite implements MetaUnitFiller,MetaUnitCollector, MetaUnitEntityItemRegistrator{
	...
	interface MultiValuedFieldUiBinder extends
			UiBinder<Widget, VarMultiValuedField> {
	}

	public VarMultiValuedField() {
	...
	public VarMultiValuedField(MetaUnitMultivaluedDTO dto,JSON_Representation represent,HashMap<String,String> fill,String base_name) {
		initWidget(uiBinder.createAndBindUi(this));
		this.dto = dto;
		this.filling = fill;
...
//				subunits_table.setWidget(i++, 0, new VarMultiValuedField(dto_str,null,filling,base_name));
//			}else
	...
	private void rebuildJSON()
	{
	    ...
	    for (int i = 0; i < this.subunits_table.getRowCount(); i++)
	    {
	      ...
	      if(!(filler instanceof VarMultiValuedField))
