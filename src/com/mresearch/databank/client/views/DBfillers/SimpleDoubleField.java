...
public class SimpleDoubleField extends Composite implements MetaUnitFiller{
	...
	interface SimpleDoubleFieldUiBinder extends
			UiBinder<Widget, SimpleDoubleField> {
	}
	...
	public SimpleDoubleField(MetaUnitDoubleDTO dto,JSON_Representation filling,String def_value,String base_name) {
		initWidget(uiBinder.createAndBindUi(this));
		this.dto = dto;
