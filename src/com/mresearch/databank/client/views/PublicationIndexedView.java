...
public class PublicationIndexedView extends Composite {
	...
	public PublicationIndexedView(PublicationDTO dto,MetaUnitMultivaluedEntityDTO dt) {
		...
		this.name.setHTML("<a class=\"headerlink yellow\">"+dto.getHeader()+"</a>");
		String date_auth = "";
...
//		
	...
	@UiHandler(value="name")
	public void onNameClick(ClickEvent ev)
	{
		doShowDeeper();
	}
	private void doShowDeeper()
	{
