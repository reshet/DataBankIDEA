...
public class ArticleBarView extends Composite {

	private static ArticleBarViewUiBinder uiBinder = GWT
			.create(ArticleBarViewUiBinder.class);

	interface ArticleBarViewUiBinder extends UiBinder<Widget, ArticleBarView> {
	}

	//@UiField Label contents;
	@UiField DisclosurePanel discPanel;
	//@UiField HTML download;
	public ArticleBarView(ArticleDTO dto) {
