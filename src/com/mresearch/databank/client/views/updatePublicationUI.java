...
public class updatePublicationUI extends Composite {
	...
	private void renderDBfillers(PublicationDTO dto,MetaUnitMultivaluedEntityDTO res,String cat_sys_name,String catalogization_str)
	{
       ...
       // richTextEditor.setZIndex(-99900);
		...
		final HashMap<String,String> map = dto.getFilling();
		 if(map.containsKey("publication_contents"))richTextEditor.setValue(map.get("publication_contents"));
	...
	@UiConstructor
	public updatePublicationUI(PublicationDTO dto,MetaUnitMultivaluedEntityDTO res,String root_concept_sysname,Long root_concept,String root_concept_name) {
...
//		
	...
	private void fillFormValues()
	{
		...
		String ss = json.getObj().toString();
