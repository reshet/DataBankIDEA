...
public class ConsultationDetailedView extends Composite {
	...
	interface ConsultationDetailedViewUiBinder extends
			UiBinder<Widget, ConsultationDetailedView> {
	}
	...
	public ConsultationDetailedView(ConsultationDTO dto,MetaUnitMultivaluedEntityDTO dt,String path) {
