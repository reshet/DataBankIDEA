...
public class VariableDetailedView extends Composite implements HTML_Saver {
  ...
  Label varText;
  @UiField
  FlexTable codeSchemeTbl, generalizedTbl;
  @UiField
  HTMLPanel main_html;
  @UiField
  Label concept_name, concept_value;
  @UiField
  Label dates, gen_geath, sel_size, org_impl, tag;
  @UiField
  HorizontalPanel analysis_bar;
  @UiField
  VerticalPanel research_link;
  ...
  private void setResearchMeta() {
    ...
    if (mapa.containsKey("socioresearch_orgs_org_impl_organization"))
      org_impl.setText(mapa.get("socioresearch_orgs_org_impl_organization"));
