...
public class UserLawPerspectiveView extends Composite implements UserLawPerspectivePresenter.Display,Place{
	...
	public UserLawPerspectiveView(SimpleEventBus bus) {
		...
		RootFilterItemAdvanced i = new RootFilterItemAdvanced(this,bus,"law","Фильтр");
