...
public class ResearchDescItemViewAll extends ResearchDescItemView{

	

	
	public ResearchDescItemViewAll(SocioResearchDTO_Light dto) {
		super(dto);
		pub_link.setHTML("<a href=\"#\" class=\"more\">Все исследования &rarr;</a>");
	}
