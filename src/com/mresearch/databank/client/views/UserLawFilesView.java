...
public class UserLawFilesView extends Composite implements AdminResearchDetailedPresenter.FilesEditDisplay{
	...
	interface AdminResearchFilesEditViewUiBinder extends
			UiBinder<Widget, UserLawFilesView> {
	}
...
//	
	...
	public UserLawFilesView(long research_id,String category,SocioResearchFilesDTO dto) {
