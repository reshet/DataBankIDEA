...
public class ConsultationIndexedView extends Composite {

	private static ConsultationDetailedViewUiBinder uiBinder = GWT
			.create(ConsultationDetailedViewUiBinder.class);

	interface ConsultationDetailedViewUiBinder extends
			UiBinder<Widget, ConsultationIndexedView> {
	}
	...
	public ConsultationIndexedView(ConsultationDTO dto,MetaUnitMultivaluedEntityDTO dt) {
		...
		this.dto =  dto;
		this.db = dt;
		this.question.setHTML(dto.getquestion()==null?"":dto.getquestion());
		this.answer.setHTML(dto.getanswer()==null?"":"<p style=\"italic\"><b>Ответ специалиста: </b>"+dto.getanswer()+"</p>");
			//this.name.setText(dto.getquestion());
...
//	{
//		DatabankApp.get().getEventBus().fireEvent(new ShowConsultationDetailsEvent(dto.getId()));
//	}
