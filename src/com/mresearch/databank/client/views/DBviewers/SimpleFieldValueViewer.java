...
public class SimpleFieldValueViewer extends Composite{
	...
	{
		if(def_value!=null && def_value.startsWith("http://"))def_value = "<a href=\""+def_value+"\">"+def_value.substring(7)+"</a>";
		if(def_value!=null) this.contents.setHTML(def_value);
	}
}
