...
public class AdminLawPerspectiveView extends Composite implements AdminLawPerspectivePresenter.Display{
	...
	interface AdminResearchPerspectiveViewUiBinder extends
			UiBinder<Widget, AdminLawPerspectiveView> {
	}
	...
	public AdminLawPerspectiveView(SimpleEventBus bus) {
