...
public class PublicationsBundleDTO implements Serializable{
    ...
    /**
     * @param last_l_index_dtos the last_l_index_dtos to set
     */
    public void setLast_l_index_dtos(ArrayList<PublicationDTO_Light> last_l_index_dtos) {
